...
function preload()
{
  bg_img = loadImage('Images/main.png');
  food = loadImage('Images/bone.png');
  doggy = loadImage('Images/dog3.png');
  ...
  blink = loadAnimation("Images/dog3.png");
  eat = loadAnimation("Images/dog1.png");
  sad = loadAnimation("Images/dog2.png");
...
function setup() 
{
  ...
  dog = createSprite(170,canH-80,100,100);
  dog.scale = 0.2;

  dog.addAnimation('blinking',blink);
...
function draw() 
{
  ...
  {
    dog.changeAnimation('eating');
    eating_sound.play();
  }

  if(bone!=null && bone.position.y>=650)
  {
    dog.changeAnimation('crying');
    bk_song.stop();
    sad_sound.play();
    bone=null;
